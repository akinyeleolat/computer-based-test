        ...
        data.courses.forEach((viewCourses) => {
          ...
          <div class="col-6 col-lg-3">
                        <div class="card">
                          ...
                          <a class="btn-block text-muted d-flex justify-content-between align-items-center" href="./test.html" target="_blank">
                              <button class="btn btn-block btn-primary" type="button" id="${viewCourses.id}">Take Test</button>
                            </a>
                          </div>
                        </div>
                      </div>
